package suryabanking.com.bean;

import suryabanking.com.infra.model.Filter;
import suryabanking.com.model.Car;
import suryabanking.com.service.CarService;
...
import static suryabanking.com.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                suryabanking.com.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? suryabanking.com.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? suryabanking.com.infra.model.SortOrder.DESCENDING
                            : suryabanking.com.infra.model.SortOrder.UNSORTED;
                }
